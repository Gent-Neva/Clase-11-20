...
class Programa():
    ...
    def __init__(self):
        ...
        #Agrega la DataBase a la app 
        db.init_app(self.app)  

        self.app.add_url_rule('/raiz', view_func=self.buscarTodos)        
    ...
    def agregar(self):
        ...
        #Verificar si se debe enviar el formulario o procesar los datos
        if request.method=="POST":
            ...
            #Guardar el objeto en la clase de Data Base
